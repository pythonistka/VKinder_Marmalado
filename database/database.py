...
def init_database():
    ...
    # db_insert_user("user_vk_idddd", "CITY_ID", 44, "SEX")
    # # Вставить пользователя
    # db_insert_partner("partner_vk_idddd", "First", "Last", "photo", "profile_url")
    # # Вставляем отношение между пользователем и просмотренными партнерами
    # db_insert_user_partner("user_vk_idddd", "partner_vk_idddd")
    # # Проверка, показывали ли мы этого пользователя ранее
    # db_check_user_was_showed("user_vk_idddd", "partner_vk_idddd")
